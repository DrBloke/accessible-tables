...
var $author$project$Main$init = {textInput: ''};
...
var $author$project$Table$ComplexHeadings = function (a) {
	return {$: 'ComplexHeadings', a: a};
};
var $author$project$Table$H = F2(
	function (a, b) {
		return {$: 'H', a: a, b: b};
	});
...
var $author$project$Table$NoData = {$: 'NoData'};
...
var $author$project$Table$render = function (config) {
	if (config.$ === 'Ok') {
		...
		if (!body.b) {
			return $elm$core$Result$Err($author$project$Table$NoData);
		} else {
...
var $author$project$Table$ColumnHeading = function (a) {
	return {$: 'ColumnHeading', a: a};
};
var $author$project$Table$ColumnHeadingGroup = F2(
	function (a, b) {
		return {$: 'ColumnHeadingGroup', a: a, b: b};
	});
var $author$project$Table$ColumnHeadingMismatch = {$: 'ColumnHeadingMismatch'};
var $author$project$Table$ColumnHeadingSingle = function (a) {
	return {$: 'ColumnHeadingSingle', a: a};
};
var $author$project$Table$ColumnHeadingsComplex = function (a) {
	return {$: 'ColumnHeadingsComplex', a: a};
};
var $author$project$Table$ColumnHeadingsSimple = function (a) {
	return {$: 'ColumnHeadingsSimple', a: a};
};
var $author$project$Table$TableConfiguration = function (a) {
...
var $author$project$Table$setColumnHeadings = F2(
			...
			return A2(
				...
				function (_v2) {
					...
					return _Utils_eq(
						...
						$author$project$Table$TableConfiguration(tableConfig)) : $elm$core$Result$Err($author$project$Table$ColumnHeadingMismatch);
				},
				A2(
					$elm$core$Result$map,
					function (_v1) {
						...
						return $author$project$Table$TableConfiguration(
							_Utils_update(
								tableConfig,
								{
									columnHeadings: $author$project$Table$ColumnHeadingsSimple(
										A2(
											$elm$core$List$map,
											function (label) {
												return $author$project$Table$ColumnHeadingSingle(
													$author$project$Table$ColumnHeading(
														{
					...
					function (_v3) {
						...
						return $author$project$Table$TableConfiguration(
							_Utils_update(
								tableConfig,
								{
									columnHeadings: $author$project$Table$ColumnHeadingsComplex(
										A2(
											$elm$core$List$map,
											function (_v4) {
												...
												return A2(
													$author$project$Table$ColumnHeadingGroup,
													$author$project$Table$ColumnHeading(
														{
															attributes: _List_Nil,
													...
													A2(
														$elm$core$List$map,
														function (subHeading) {
															return $author$project$Table$ColumnHeading(
																{
																	attributes: _List_Nil,
...
var $author$project$Table$RowLengthsDoNotMatch = function (a) {
	return {$: 'RowLengthsDoNotMatch', a: a};
};
var $author$project$Table$allRowsEqualLengthHelper = F3(
			...
			if (!remainingRows.b) {
				...
				if (_Utils_eq(
					...
					return $elm$core$Result$Err(
						$author$project$Table$RowLengthsDoNotMatch(rowNumber));
				}
			}
		}
	});
var $author$project$Table$allRowsEqualLength = function (data) {
	if (!data.b) {
		...
		return A3(
			$author$project$Table$allRowsEqualLengthHelper,
			$elm$core$List$length(row1),
			2,
			remainingRows);
	}
};
var $author$project$Table$simpleTable = function (data) {
	var _v0 = $author$project$Table$allRowsEqualLength(data);
	if (_v0.$ === 'Ok') {
		var noOfCols = _v0.a;
		return $elm$core$Result$Ok(
			$author$project$Table$TableConfiguration(
				{
					attributes: _List_Nil,
					...
					cells: A2(
						...
						function (row) {
							return A2(
								$elm$core$List$map,
								function (v) {
									return $author$project$Table$Cell(
										{
											attributes: _List_Nil,
				...
				$author$project$Table$ComplexHeadings(
					_List_fromArray(
						[
							...
							_List_fromArray(
								['sub 1', 'sub2'])),
							A2($author$project$Table$H, 'Two', _List_Nil),
							A2(
							$author$project$Table$H,
							'Three',
							_List_fromArray(
